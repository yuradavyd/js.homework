...
// //     document.body.innerHTML+= `<div class="member"></div>`
// // }
//
// //
...
//     divSurname.textContent = `${element.surname}`;
//     let divAge = document.createElement('div');
//     divAge.textContent = `${element.age}`;
//     let divInfo = document.createElement('p');
//     divInfo.textContent = `${element.info}`;
//     let divPhoto = document.createElement('img');
//     divPhoto.src = `${element.photo}`;
//     newDiv.append(divName, divSurname, divAge, divInfo, divPhoto);
...
for (let element of coursesArray) {
    ...
    divMonthDuration.textContent = `MonthDuration - ${element.monthDuration},`;
    let divHourDuration = document.createElement('div');
    divHourDuration.textContent = ` HourDuration - ${element.hourDuration}`;
    let durationWrap = document.createElement('div');
    durationWrap.classList.add('durationWrap');
    durationWrap.append(divMonthDuration,divHourDuration)
    let modules = document.createElement('ul')
    for (element of element['modules']) {
        let liModules = document.createElement('li');
        liModules.textContent = `${element}`
        modules.appendChild(liModules);
    }
    newDiv.append(divTitle, durationWrap,modules);
    document.body.appendChild(newDiv);
}